...
@Scope("singleton")
@Service("GeneroLogic")
public class GeneroLogic implements IGeneroLogic {
    private static final Logger log = LoggerFactory.getLogger(GeneroLogic.class);

    /**
     * DAO injected by Spring that manages Genero entities
     *
     */
    @Autowired
    ...
    */
    ...
    public List<Genero> getGenero() throws Exception {
        ...
        try {
            list = generoDAO.findAll();
        } catch (Exception e) {
            log.error("finding all Genero failed", e);
    ...
    public void saveGenero(Genero entity) throws Exception {
        ...
        try {
            ...
            validateGenero(entity);

            if (getGenero(entity.getIdgenero()) != null) {
                throw new ZMessManager(ZMessManager.ENTITY_WITHSAMEKEY);
            }

            generoDAO.save(entity);

            log.debug("save Genero successful");
        } catch (Exception e) {
    ...
    public void deleteGenero(Genero entity) throws Exception {
        ...
        if (entity.getIdgenero() == null) {
            throw new ZMessManager().new EmptyFieldException("idgenero");
        }

        List<Obras> obrases = null;

        try {
            obrases = obrasDAO.findByProperty("genero.idgenero",
                    entity.getIdgenero());
    ...
    public void updateGenero(Genero entity) throws Exception {
        ...
        try {
            ...
            generoDAO.update(entity);

            log.debug("update Genero successful");
        } catch (Exception e) {
    ...
    public List<GeneroDTO> getDataGenero() throws Exception {
        try {
            ...
            for (Genero generoTmp : genero) {
                GeneroDTO generoDTO2 = generoMapper.generoToGeneroDTO(generoTmp);
                generoDTO.add(generoDTO2);
            }
    ...
    public Genero getGenero(Integer idgenero) throws Exception {
        ...
        try {
            entity = generoDAO.findById(idgenero);
        } catch (Exception e) {
            log.error("get Genero failed", e);
            throw new ZMessManager().new FindingException("Genero");
        } finally {
        }
    ...
    public List<Genero> findPageGenero(String sortColumnName,
        ...
        throws Exception {
        List<Genero> entity = null;

        try {
            entity = generoDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Genero Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Genero> findByCriteria(Object[] variables,
        ...
        try {
            list = generoDAO.findByCriteria(where);
        } catch (Exception e) {
